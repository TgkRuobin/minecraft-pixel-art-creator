    ...
    <div class="core">
      ...
      <div class="counter" v-if="usedBlock.length > 0">
        ...
        <div style="display: flex;flex-flow: wrap row;gap: 10px;">
          <h4>{{ lang.info }}</h4>
          <img @click="sortByNumber" src="https://mcpixelart.com/img/排序.svg" alt="数量降序" title="按方块数量降序">
        </div>
      ...
      if(this.posInfo.length > 0){
        ...
        .then(response=>{
          if(response.data && response.data.url){
            ...
            const href = 'https://mcpixelart.com/lite/' + response.data.url
            a.href = href
...
<style scoped>
  ...
  .bgc{
    ...
    background-image: url("https://mcpixelart.com/img/bg_pink.png");
  ...
  .colorShow{
    ...
    height: 16px;
    margin-right: 6px;
    background-image: url('https://mcpixelart.com/img/BlockCSS.png');
