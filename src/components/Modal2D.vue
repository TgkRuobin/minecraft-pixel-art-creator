<template>
  <div v-show="visible" class="outer-2d">
    ...
    <!-- 根据语言选择tip -->
    <img :src="lang_now === 'lang_cn' ? 'https://mcpixelart.com/img/modal2d-tip.png' : 'https://mcpixelart.com/img/modal2d-tip-en.png'" class="d2d-tip">
    <div class="wall-corner">
      <div class="arrow-2d-scale arrow-2d-scale-x">
        <img src="https://mcpixelart.com/img/箭头.svg" class="arrow-2d-img">
      </div>
